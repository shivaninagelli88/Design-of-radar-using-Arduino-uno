...
void drawText() { // draws the text on the screen
  ...
  text("30", 0, 0);
  resetMatrix();
  translate((width - width * 0.4994) + width / 2 * cos(radians(60)), 
            (height - height * 0.0907) - width / 2 * sin(radians(60)));
  rotate(-radians(-30));
  text("60", 0, 0);
  resetMatrix();
  translate((width - width * 0.4994) + width / 2 * cos(radians(90)), 
            (height - height * 0.0907) - width / 2 * sin(radians(90)));
  rotate(-radians(0));
  text("90", 0, 0);
  resetMatrix();
  translate((width - width * 0.4994) + width / 2 * cos(radians(120)), 
            (height - height * 0.0907) - width / 2 * sin(radians(120)));
  rotate(-radians(30));
  text("120", 0, 0);
  resetMatrix();
  translate((width - width * 0.4994) + width / 2 * cos(radians(150)), 
            (height - height * 0.0907) - width / 2 * sin(radians(150)));
  rotate(-radians(60));
  text("150", 0, 0);
  popMatrix();
}
